...
document.addEventListener("click", function (e) {
  ...
  if (targetElement.closest(".slide")) {
    ...
    const activeImage = document.querySelector(".slide_picture.active");
  ...
  if (targetElement.closest(".open-image")) {
    const openImage = targetElement.closest(".opem-image");
    const activeImage = document.querySelector(".slide_picture.active");
...
function imageOpen(image) {
  ...
  const openImage = document.cloneNode();
